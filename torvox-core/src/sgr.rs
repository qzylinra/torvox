...
impl SgrAttribute {
    ...
    ///
    /// ```
    /// use torvox_core::sgr::SgrAttribute;
    ///
    ...
    /// assert_eq!(SgrAttribute::from_code(24), Some(SgrAttribute::Underline(torvox_core::sgr::UnderlineStyle::None)));
...
///
/// ```
/// use torvox_core::sgr::{color_from_spec, ColorSpec};
