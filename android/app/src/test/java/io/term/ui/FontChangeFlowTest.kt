...
class FontChangeFlowTest {
    ...
    fun settingsScreenShowsFontFamilyLabel() {
        ...
        val label = context.getString(io.term.R.string.font_family)
    ...
    fun settingsScreenShowsChangeLabel() {
        val label = context.getString(io.term.R.string.change)
    ...
    fun settingsScreenShowsPickFontFileLabel() {
        val label = context.getString(io.term.R.string.pick_font_file)
