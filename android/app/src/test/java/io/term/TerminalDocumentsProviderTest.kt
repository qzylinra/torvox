...
class TorvoxDocumentsProviderTest {
    ...
    fun encodeDocIdDecodeDocIdRoundTrip() {
        ...
        file.createNewFile()
        val docId = TerminalDocumentsProvider.encodeDocId(file, testRootDir)
        assertEquals("test.txt", docId)
        val decoded = TerminalDocumentsProvider.decodeDocId(docId, testRootDir)
    ...
    fun decodeDocIdCreatesFileObject() {
        ...
        val file = TerminalDocumentsProvider.decodeDocId(path, testRootDir)
