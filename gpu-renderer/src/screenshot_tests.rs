...
fn theme_fg() -> [f32; 4] {
    let c = terminal_core::config::Theme::catppuccin_mocha().foreground;
    [
        c[0] as f32 / 255.0,
        c[1] as f32 / 255.0,
        c[2] as f32 / 255.0,
...
fn theme_bg() -> [f32; 4] {
    let c = terminal_core::config::Theme::catppuccin_mocha().background;
    [
        c[0] as f32 / 255.0,
        c[1] as f32 / 255.0,
        c[2] as f32 / 255.0,
...
fn theme_ansi(i: usize) -> [f32; 4] {
    let c = terminal_core::config::Theme::catppuccin_mocha().ansi[i];
    [
        c[0] as f32 / 255.0,
        c[1] as f32 / 255.0,
        c[2] as f32 / 255.0,
