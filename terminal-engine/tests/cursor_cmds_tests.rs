...
use terminal_engine::cursor_cmds::{assert_cup, assert_relative};
use terminal_engine::test_helpers::assert_invariants;

fn term() -> terminal_engine::ghostty_terminal::GhosttyTerminal {
    terminal_engine::ghostty_terminal::GhosttyTerminal::new(10, 30, 100).expect("terminal")
}

fn sized(r: u32, c: u32) -> terminal_engine::ghostty_terminal::GhosttyTerminal {
    terminal_engine::ghostty_terminal::GhosttyTerminal::new(r, c, 100).expect("terminal")
}
