use super::core::{NativeBridge, with_bridge};
use super::types::*;
use super::wire_format::*;

/// # Safety
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
/// The ANativeWindow pointer reconstructed from `window_ptr_low` and `window_ptr_high` must be a valid, non-null pointer.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_native_window(
    handle: i64,
    window_ptr_low: u32,
    window_ptr_high: u32,
    width: u32,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_resize(handle: i64, rows: u32, cols: u32) -> i32 {
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_update_native_window(
    handle: i64,
    window_ptr_low: u32,
    window_ptr_high: u32,
    width: u32,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_recompute_grid(handle: i64, width: u32, height: u32) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_surface_size(handle: i64, width: u32, height: u32) {
    with_bridge(handle, |bridge| {
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_spawn_terminal(handle: i64, rows: u32, cols: u32) -> i32 {
...
/// # Safety
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_release_gpu_surface(handle: i64) {
    if let Err(e) = with_bridge(handle, |bridge| {
        bridge.release_gpu_surface();
        Ok::<_, BridgeError>(())
    }) {
        log::error!("bridge_release_gpu_surface: {e}");
    }
}
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_release_surface(handle: i64) {
    if let Err(e) = with_bridge(handle, |bridge| {
        bridge.release_surface();
        Ok::<_, BridgeError>(())
    }) {
        log::error!("bridge_release_surface: {e}");
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_save_path(
    handle: i64,
    path_ptr: *const u8,
    path_len: i32,
) -> i32 {
...
/// `path_ptr` must be valid for reads of `path_len` bytes, and must not be aliased.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_has_saved_session(
    handle: i64,
    path_ptr: *const u8,
    path_len: i32,
) -> bool {
...
/// `path_ptr` must be valid for reads of `path_len` bytes, and must not be aliased.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_save_session(
    handle: i64,
    path_ptr: *const u8,
    path_len: i32,
) -> i32 {
...
/// `path_ptr` must be valid for reads of `path_len` bytes, and must not be aliased.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_restore_session(
    handle: i64,
    path_ptr: *const u8,
    path_len: i32,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_write_to_pty(
    handle: i64,
    data_ptr: *const u8,
    data_len: i32,
) -> i32 {
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_process_key_event(
    handle: i64,
    key_code: u32,
    modifiers: u8,
    action: u8,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_terminal_text(handle: i64) -> i64 {
    let text = match with_bridge(handle, |bridge| Ok(bridge.get_terminal_text())) {
        Ok(t) => t,
        Err(e) => {
            log::error!("bridge_get_terminal_text: {e}");
            return 0;
        }
    };
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_active_session_title(handle: i64) -> i64 {
    let title = match with_bridge(handle, |bridge| Ok(bridge.get_active_session_title())) {
        Ok(t) => t,
        Err(e) => {
            log::error!("bridge_get_active_session_title: {e}");
            return 0;
        }
    };
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_default_font_name(handle: i64) -> i64 {
    let name = match with_bridge(handle, |bridge| Ok(bridge.get_default_font_name())) {
        Ok(n) => n,
        Err(e) => {
            log::error!("bridge_get_default_font_name: {e}");
            return 0;
        }
    };
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_font_info(handle: i64) -> i64 {
    let info = match with_bridge(handle, |bridge| Ok(bridge.get_font_info())) {
        Ok(i) => i,
        Err(e) => {
            log::error!("bridge_get_font_info: {e}");
            return 0;
        }
    };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_system_locale(
    handle: i64,
    ...
    if let Err(error) = with_bridge(handle, |bridge| {
        ...
        log::error!("bridge: bridge_set_system_locale failed: {error}");
    }
}
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_list_font_families(handle: i64) -> i64 {
    let families = match with_bridge(handle, |bridge| Ok(bridge.list_font_families())) {
        Ok(f) => f,
        Err(e) => {
            log::error!("bridge_list_font_families: {e}");
            return 0;
        }
    };
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_grid_rows(handle: i64) -> u32 {
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_grid_cols(handle: i64) -> u32 {
    with_bridge(handle, |bridge| Ok(bridge.get_grid_cols())).unwrap_or(DEFAULT_GRID_COLS)
}

/// # Safety
/// `handle` must be a valid bridge handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_cell_width(handle: i64) -> f32 {
...
/// `handle` must be a valid bridge handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_cell_height(handle: i64) -> f32 {
...
/// `handle` must be a valid bridge handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_get_grid_rows_cols(handle: i64) -> u64 {
    with_bridge(handle, |bridge| {
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_font_size(handle: i64, size_tenths: u32) -> i32 {
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_font_size_in_place(handle: i64, size_tenths: u32) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_extra_font_paths(
    handle: i64,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_selection(
    handle: i64,
    start_row: i32,
    start_col: i32,
    end_row: i32,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_expand_and_set_selection(
    handle: i64,
    row: u32,
    col: u32,
    mode: i32,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_is_cell_empty(handle: i64, row: u32, col: u32) -> i32 {
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_has_text_in_range(
    handle: i64,
    start_row: u32,
    start_col: u32,
    end_row: u32,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_selection_endpoint(
    handle: i64,
    handle_side: u8,
    anchor_row: i32,
    anchor_col: i32,
...
/// `data_ptr` must be valid for reads of `data_len` bytes, and must not be aliased.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_search_highlights(
    handle: i64,
    data_ptr: *const u8,
    data_len: i32,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_font_family(
    handle: i64,
    family_ptr: *const u8,
    family_len: i32,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_theme(
    handle: i64,
    theme_ptr: *const u8,
    theme_len: i32,
) -> i32 {
    ...
    let name = match read_wire_string(bytes, &mut pos) {
        ...
        None => {
            log::error!(
                "bridge_set_theme: truncated theme buffer ({} bytes) — could not read name",
                bytes.len()
            );
            return -1;
        }
    ...
    let read_color = |bytes: &[u8], pos: &mut usize| -> u32 {
        let color_value = read_u32_le(bytes, *pos).unwrap_or_else(|| {
            log::error!("bridge_set_theme: truncated theme buffer at pos={pos}");
            0
        });
        *pos += 4;
        color_value
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_scrollback_line(handle: i64, index: u32) -> i64 {
    let line = match with_bridge(handle, |bridge| Ok(bridge.scrollback_line(index))) {
        Ok(l) => l,
        Err(e) => {
            log::error!("bridge_scrollback_line: {e}");
            return 0;
        }
    };
    match line {
...
/// `bridge_scrollback_line` or `bridge_search_in_scrollback`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_free_string(s: i64) {
    if s != 0 {
...
/// # Safety
/// `handle` must be a valid bridge handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_ping(handle: i64) -> i32 {
    log::debug!("bridge_ping: handle={handle:#x}");
    match with_bridge(handle, |bridge| bridge.ping()) {
        Ok(_) => 0,
        Err(e) => {
            log::error!("bridge_ping: error: {e}");
            -1
        }
    }
}
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_render(handle: i64, skip_output: u8) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_poll_bel(handle: i64) -> i32 {
...
/// `handle` must be a valid surface handle.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_poll_shell_integration(handle: i64) -> i32 {
...
/// `handle` must be a valid surface handle.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_poll_sync_active(handle: i64) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_save_test_frame(
    handle: i64,
...
/// # Safety
/// Same as `bridge_save_test_frame` but sets selection first, all within
/// one surface lock acquisition. Pass -1 for any row/col to clear selection.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_save_test_frame_with_selection(
    handle: i64,
    data_dir: *const std::ffi::c_char,
    start_row: i32,
    start_col: i32,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_poll_clipboard(handle: i64) -> i64 {
    let clipboard = match with_bridge(handle, |bridge| Ok(bridge.poll_clipboard())) {
        Ok(c) => c,
        Err(e) => {
            log::error!("bridge_poll_clipboard: {e}");
            return 0;
        }
    };
    match clipboard {
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_poll_notification(handle: i64) -> i64 {
    let notification = match with_bridge(handle, |bridge| Ok(bridge.poll_notification_raw())) {
        Ok(n) => n,
        Err(e) => {
            log::error!("bridge_poll_notification: {e}");
            return 0;
        }
    };
    match notification {
...
/// # Safety
/// `ptr` must be a valid pointer previously returned by `bridge_poll_notification`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_free_notification(ptr: i64) {
    if ptr != 0 {
        // SAFETY: The caller guarantees ptr was returned by
        // bridge_poll_notification, which allocates a Box<[*mut c_char; 2]>
...
/// `handle` must be a valid bridge handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_poll_all(handle: i64) -> i64 {
    let result = match with_bridge(handle, |bridge| Ok(bridge.poll_all())) {
        Ok(r) => r,
        Err(e) => {
            log::error!("bridge_poll_all: {e}");
            return 0;
        }
    };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_wait_output(handle: i64, timeout_ms: u64) -> i32 {
    match with_bridge(handle, |bridge| {
        ...
        Ok(false) => 0,
        Err(e) => {
            log::debug!("bridge_wait_output: {e}");
            0
        }
    }
}
...
/// # Safety
/// `ptr` must be a valid pointer previously returned by `bridge_poll_all`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_free_poll_all(ptr: i64) {
    if ptr != 0 {
        // SAFETY: ptr was returned by bridge_poll_all, which allocates a
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_cwd(handle: i64) -> *mut std::ffi::c_char {
    let cwd = match with_bridge(handle, |bridge| Ok(bridge.cwd())) {
        Ok(c) => c,
        Err(e) => {
            log::error!("bridge_cwd: {e}");
...
/// # Safety
/// `s` must be a valid surface handle pointer previously returned by `bridge_cwd`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_free_cstring(s: *mut std::ffi::c_char) {
    if !s.is_null() {
        // SAFETY: The caller guarantees s was returned by bridge_cwd,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_focus_event(handle: i64, focused: i32) {
    if let Err(e) = with_bridge(handle, |bridge| {
        bridge.focus_event(focused != 0);
        Ok::<_, BridgeError>(())
    }) {
        log::error!("bridge_focus_event: {e}");
    }
}
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`, or zero.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_scrollback_len(handle: i64) -> u32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_search_in_scrollback(
    handle: i64,
    query_ptr: *const u8,
    query_len: i32,
) -> i64 {
    ...
    let result = match with_bridge(handle, |bridge| Ok(bridge.search_in_scrollback(query))) {
        Ok(r) => r,
        Err(e) => {
            log::error!("bridge_search_in_scrollback: {e}");
            return 0;
        }
    };
    match result {
...
/// `query_ptr` must be valid for reads of `query_len` bytes, and must not be aliased.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_search_all_in_scrollback(
    handle: i64,
    query_ptr: *const u8,
    query_len: i32,
    case_sensitive: u8,
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_scroll_offset(handle: i64, offset: i32) {
    if let Err(e) = with_bridge(handle, |bridge| {
        bridge.set_scroll_offset(offset as u32);
        Ok::<_, BridgeError>(())
    }) {
        log::error!("bridge_set_scroll_offset: {e}");
    }
}
...
/// `handle` must be a valid surface handle previously returned by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_wait_until_ready_for_render(handle: i64) {
    if let Err(e) = with_bridge(handle, |bridge| {
        bridge.wait_until_ready_for_render();
        Ok::<_, BridgeError>(())
    }) {
        log::error!("bridge_wait_until_ready_for_render: {e}");
    }
}

/// # Safety
/// `handle` must be a valid pointer to a `NativeBridge` created by `bridge_new`.
/// `data` must point to valid RGBA pixel data of at least `len` bytes.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_background_image(
    handle: i64,
    data: *const u8,
    len: i32,
    width: i32,
    ...
    if let Err(error) = with_bridge(handle, |bridge| {
        ...
        log::error!("bridge: bridge_set_background_image failed: {error}");
    }
}
...
/// `handle` must be a valid pointer to a `NativeBridge` created by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_background_params(
    handle: i64,
    blur_radius: i32,
    alpha_tenths: i32,
) {
    if let Err(error) = with_bridge(handle, |bridge| {
        ...
        log::error!("bridge: bridge_set_background_params failed: {error}");
    }
}
...
/// `handle` must be a valid pointer to a `NativeBridge` created by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_clear_background_image(handle: i64) {
    if let Err(error) = with_bridge(handle, |bridge| bridge.clear_background_image()) {
        log::error!("bridge: bridge_clear_background_image failed: {error}");
    }
}
...
/// `handle` must be a valid pointer to a `NativeBridge` created by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_render_paused(handle: i64, paused: i32) {
    if let Err(e) = with_bridge(handle, |bridge| {
        bridge.set_render_paused(paused != 0);
        Ok::<_, BridgeError>(())
    }) {
        log::error!("bridge_set_render_paused: {e}");
    }
}
...
/// `handle` must be a valid pointer to a `NativeBridge` created by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_cursor_blink_enabled(handle: i64, enabled: i32) {
    if let Err(error) = with_bridge(handle, |bridge| {
        bridge.set_cursor_blink_enabled(enabled != 0)
    }) {
        log::error!("bridge: bridge_set_cursor_blink_enabled failed: {error}");
    }
}
...
/// `handle` must be a valid pointer to a `NativeBridge` created by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_cursor_blink_speed_ms(handle: i64, speed_ms: i32) {
    if let Err(error) = with_bridge(handle, |bridge| {
        bridge.set_cursor_blink_speed_ms(speed_ms as u32)
    }) {
        log::error!("bridge: bridge_set_cursor_blink_speed_ms failed: {error}");
    }
}
...
/// `handle` must be a valid pointer to a `NativeBridge` created by `bridge_new`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_reset_cursor_blink(handle: i64) {
    if let Err(error) = with_bridge(handle, |bridge| bridge.reset_cursor_blink()) {
        log::error!("bridge: bridge_reset_cursor_blink failed: {error}");
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_set_cursor_style(
    handle: i64,
    style_ptr: *const u8,
    style_len: i32,
) {
    ...
    if let Err(error) = with_bridge(handle, |bridge| bridge.set_cursor_style(style)) {
        log::error!("bridge: bridge_set_cursor_style failed: {error}");
    }
}
...
///   `bridge_create` and not yet destroyed.
...
pub unsafe extern "C" fn bridge_get_snapshot(
    ...
    unsafe {
        let bridge = match (handle as *mut NativeBridge).as_mut() {
            Some(b) => b,
            None => return -1,
        };
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn bridge_load_font_file(
    handle: i64,
    path_ptr: *const u8,
    path_len: i32,
) -> *mut core::ffi::c_char {
