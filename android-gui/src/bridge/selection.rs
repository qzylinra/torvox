...
//! owns that pure computation so it can be unit-tested without a `NativeBridge`,
...
use terminal_core::selection::{ExpansionOptions, Selection, SelectionAnchor, SelectionMode};
