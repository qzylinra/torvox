...
impl From<terminal_core::cell::Attrs> for BridgeAttrs {
    fn from(attributes: terminal_core::cell::Attrs) -> Self {
        Self {
...
impl From<BridgeAttrs> for terminal_core::cell::Attrs {
...
impl From<terminal_core::cell::Cell> for BridgeCell {
    fn from(cell: terminal_core::cell::Cell) -> Self {
        Self {
...
impl From<BridgeCell> for terminal_core::cell::Cell {
    fn from(bridge_cell: BridgeCell) -> Self {
        Self {
            ...
            background: terminal_core::cell::Color {
...
impl From<Shell> for terminal_core::config::Shell {
    fn from(shell: Shell) -> Self {
        match shell {
            Shell::SystemDefault => terminal_core::config::Shell::SystemDefault,
            Shell::Custom { path } => terminal_core::config::Shell::Custom(path),
        }
    }
}

impl From<terminal_core::config::Shell> for Shell {
    fn from(core_shell: terminal_core::config::Shell) -> Self {
        match core_shell {
            terminal_core::config::Shell::SystemDefault => Shell::SystemDefault,
            terminal_core::config::Shell::Custom(path) => Shell::Custom { path },
        }
    }
}
...
impl From<terminal_core::config::Theme> for BridgeTheme {
    fn from(theme: terminal_core::config::Theme) -> Self {
        Self {
            name: theme.name,
...
impl From<BridgeTheme> for terminal_core::config::Theme {
...
impl TerminalConfig {
    pub fn to_core_config(&self) -> terminal_core::config::TerminalConfig {
        terminal_core::config::TerminalConfig {
            rows: self.rows,
            cols: self.cols,
            scrollback_lines: self.scrollback_lines,
            shell: self.shell.clone().into(),
            font_size_tenths: self.font_size_tenths,
            backspace_mode: terminal_core::config::BackspaceMode::default(),
            right_alt_mode: terminal_core::config::RightAltMode::default(),
        }
    }

    pub fn from_core_config(core_config: &terminal_core::config::TerminalConfig) -> Self {
        Self {
...
impl From<terminal_core::event::TerminalEvent> for TerminalEvent {
    fn from(event: terminal_core::event::TerminalEvent) -> Self {
        match event {
            terminal_core::event::TerminalEvent::OutputReady => TerminalEvent::DirtyRegion {
                start_row: 0,
                end_row: 0,
            },
            terminal_core::event::TerminalEvent::Bell => TerminalEvent::Bell,
            terminal_core::event::TerminalEvent::TitleChanged(title) => {
                TerminalEvent::TitleChanged { title }
            }
            terminal_core::event::TerminalEvent::ClipboardRequest(text) => {
                TerminalEvent::ClipboardRequest { text }
            }
            terminal_core::event::TerminalEvent::HyperlinkHover(url) => {
                TerminalEvent::HyperlinkHover { url }
            }
            terminal_core::event::TerminalEvent::ProcessExited(exit_code) => {
                TerminalEvent::ProcessExited { exit_code }
            }
            terminal_core::event::TerminalEvent::CursorChanged(cursor) => {
                TerminalEvent::CursorChanged {
                    row: cursor.row,
                    col: cursor.col,
                }
            }
            terminal_core::event::TerminalEvent::SelectionChanged(sel) => match sel {
                Some(selection) => {
            ...
            terminal_core::event::TerminalEvent::DirtyRegion(dirty) => TerminalEvent::DirtyRegion {
